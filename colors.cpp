    ...
    class Theme {
        ...
        public:
            std::map<std::string, sf::Color> get_colors() {
                ...
                colors.insert(std::pair<std::string, sf::Color>("highlight", this->HIGHLIGHT));
                colors.insert(std::pair<std::string, sf::Color>("selection", this->SELECTION));
    ...
    class DarkTheme : public Theme
    {
        public:
            DarkTheme() {
                ...
                this->HIGHLIGHT = sf::Color(255, 255, 255, 10);
                this->SELECTION = sf::Color(255, 255, 255, 50);
            }
    };
    ...
    class LightTheme : public Theme
    {
        public:
            LightTheme() {
                ...
                this->HIGHLIGHT = sf::Color(0, 0, 0, 10);
                this->SELECTION = sf::Color(0, 0, 0, 50);
            }
    };
}
